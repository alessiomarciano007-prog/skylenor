"use client"; // abilita gli handler lato client (es. onSubmit)
...
export default function Home() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault(); // per ora non inviamo: evitiamo il reload della pagina
  ...
  return (
    <main style={{ maxWidth: 960, margin: "0 auto", padding: "40px 16px" }}>
      ...
      <section id="operators" style={{ marginTop: 56 }}>
        ...
        <a
          href="#"
          style={{ display: "inline-block", marginTop: 16, padding: "12px 18px", borderRadius: 10, border: "1px solid #111" }}
        >
